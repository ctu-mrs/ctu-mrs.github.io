...
```
ros2 launch mrs_vins_imu_filter filter_icm_42688.launch.py
```

To use with the RealSense T265 IMU:

```
ros2 launch mrs_vins_imu_filter filter_t265.launch.py
```

## Configuration

Edit or create configs in `config/` folder.
