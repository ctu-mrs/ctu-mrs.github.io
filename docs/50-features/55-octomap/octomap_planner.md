...
The path planning is followed by generation of a trajectory along the planned path, which is then sent as a request for trajectory tracking to the [MRS trajectory tracker](https://github.com/ctu-mrs/mrs_uav_trackers/tree/ros2).
...
* sends the trajectory generation request to [MRS UAV trajectory generator](https://github.com/ctu-mrs/mrs_uav_trajectory_generation/tree/ros2),
* publishes the obtained trajectory reference to [MRS trajectory tracker](https://github.com/ctu-mrs/mrs_uav_trackers/tree/ros2),
...
* [mrs_modules_msgs](https://github.com/ctu-mrs/mrs_modules_msgs/tree/ros2)
* [mrs_subt_planning_lib](https://github.com/ctu-mrs/mrs_subt_planning_lib/tree/ros2)
* [octomap_ros](https://github.com/OctoMap/octomap_ros/tree/ros2)
