...
\begin{tikzpicture}[scale=3, tdplot_main_coords,
  ...
  \begin{scope}[xshift = 0]
    ...
    \drawDrone{(mc1)}{0.1}{thin, draw=green!60!black}
    \draw [red, very thick, ->] (mc1) -- (mo1) node [midway, red, yshift=-0.3cm, sloped] {disturbance};

    \node at ($ (mo1) + (txtOff) $) {odometry};
    \node [green!60!black] at ($ (mc1) + (txtOff) $) {command};
  \end{scope}
  ...
  \begin{scope}[xshift = 5cm]
    ...
    \drawDrone{(mc2)}{0.1}{thin, draw=green!60!black}
    \draw [red, very thick, ->] (mc2) -- (mo2) node [midway, red, yshift=-0.3cm, sloped] {disturbance};

    \drawDrone{(3.6, 1.4)}{0.1}{thick, dotted, draw=green!60!black}

    \node at ($ (mo2) + (0, 0.3) $) {odometry};
    \node [green!60!black] at ($ (mc2) + (0, 0.3) $) {command};
    \node [green!60!black, align=center] at (3.6, 1.8) {prev.\\command};
  \end{scope}
