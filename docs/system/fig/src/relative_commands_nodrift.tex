...
\begin{tikzpicture}[scale=3,
  ...
  \begin{scope}[xshift = 0]
    ...
    \draw [blue, very thick, ->] (mc1) -- (mn1) node [midway, blue, yshift=-0.5cm, sloped, align=center] {des.\\velocity};
    ...
    \draw [blue, dashed, very thick, ->] (0.5, 1.7) -- ++(3, 0) node [blue, above, align=center] {intended\\trajectory};
  \end{scope}
  ...
  \begin{scope}[xshift = 5cm]
    ...
    \coordinate (mo1) at (1.5, 1);
    \coordinate (mc1) at ($ (mo1) + (0.8, 0.7) $);
    \coordinate (mn1) at (3.5, 1.7);
    ...
    \draw [blue, dashed, very thick, ->] (0.5, 1.7)  node [blue, above, xshift=1cm, align=center] {intended\\trajectory} -- ++(3, 0);
    \draw [red, dashed, very thick, ->] (0.5, 1) -- (mo1) node [red, midway, sloped, above, align=center, xshift=-0.8cm] {actual\\trajectory};
  \end{scope}
