...
The [mrs_uav_trajectory_generation](../50-features/30-trajectory_generation/index.md) serves to generate a feasible time-parametrized trajectory from a desired waypoint path.
