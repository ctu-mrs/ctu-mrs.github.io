...
2. **Good quality texture - SLOW BUT NICE**
    ...
    3. **Meshlab**
        ...
        - Open **Transfer: Vertex Attributes to Texture (1 or 2 meshes)** tool
            ...
            - Uncheck **Fill Texture** checkbox. If you leave it checked, the final size of the texture file will be slightly higher due to filling of the empty texture file space with similar color as surroundings.
            - Click **Apply**
